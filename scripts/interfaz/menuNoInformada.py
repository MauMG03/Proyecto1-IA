...
def menuNoInformada():
    ...
    def opcionProfundidad():
        while True:
            ...
            #Se llama a la función de profundidad si se selecciono un archivo
            if file:
                informacion = profundidad(file[0])
    ...
    def opcionAmplitud():
        while True:
            ...
            #Se llama a la función de amplitud si se selecciono un archivo
            if file:
                informacion = amplitud(file[0])
                animacion(informacion)
            else:
                messagebox.showwarning("Error", "No se seleccionó ningún archivo") 
    ...
    def opcionCosto():
        while True:
            ...
            #Se llama a la función de costo si se selecciono un archivo
            if file:
                informacion = costo(file[0])
                animacion(informacion)
            else:
                messagebox.showwarning("Error", "No se seleccionó ningún archivo")
